...
console.log("detected primary Browser Language: ", lang);
console.log("Language Code (short): ", shortLang);
console.log("navigator.languages Array: ", navigator.languages);
...
// const browserLanguage = i18n.changeLanguage();
// console.log("Browser Language: ", i18n.changeLanguage());
